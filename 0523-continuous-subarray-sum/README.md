...
<pre style="position: relative;"><strong>Input:</strong> nums = [23,<u>2,4</u>,6,7], k = 6
...
<pre style="position: relative;"><strong>Input:</strong> nums = [<u>23,2,6,4,7</u>], k = 6
<strong>Output:</strong> true
...
<pre style="position: relative;"><strong>Input:</strong> nums = [23,2,6,4,7], k = 13
